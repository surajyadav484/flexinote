...
const Navigation = () => {
    ...
    return (
    <>
    <aside ref={sidebarRef} className={cn("w-60 group/sidebar h-full bg-secondary overflow-y-auto relative flex flex-col z-[99999]", isResetting && 'transition-all ease-out duration-300', isMobile && "w-0")}>
      ...
      <div onMouseDown={handleMouseDown} onClick={resetWidth} className="opacity-0 group-hover/sidebar:opacity-100 h-full transition cursor-ew-resize absolute w-1 bg-primary/10 right-0 top-0" />
    </aside>
